...
-- Multimedia keys for volume and LCD brightness. Volume goes to the Sonos Beam
-- when the UCA202 is the output, and to PipeWire otherwise (see the script).
local volume = os.getenv("HOME") .. "/.config/dotfiles/linux/scripts/sonos-volume.py"
